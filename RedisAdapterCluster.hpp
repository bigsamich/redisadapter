...
#ifndef RedisAdapterClusterCluster_HPP
#define RedisAdapterClusterCluster_HPP
...
using namespace sw::redis;
  /**
   * RedisAdapterClusterCluster
   */
class RedisAdapterCluster: public IRedisAdapter {

   public:
	/*Constructor / Destructor*/
    RedisAdapterCluster(string key, string connection = "tcp://127.0.0.1:6380");
